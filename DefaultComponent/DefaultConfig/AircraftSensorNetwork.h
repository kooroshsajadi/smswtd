...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedAircraftSensorNetwork : virtual public AOMInstance {
    DECLARE_META(AircraftSensorNetwork, OMAnimatedAircraftSensorNetwork)
