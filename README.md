...
- **Textual requirements specification**
  - `sysml_requirements_analysis-1.md`: prose description of the requirements, including tables for functional requirements (REQ‑100/200/300) and the non‑functional requirements set (REQ‑400/401–406), plus traceability and validation planning information. [file:37]

## Status

The project is currently focused on **requirements definition and structuring**. Next planned steps are to refine performance requirements as needed, add satisfaction/verification links to design and test elements, and extend the model with SysML BDD/IBD diagrams.
